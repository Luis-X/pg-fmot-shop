...
export const externalAccountList = '/api/admin/pointAccount/selectForAdmin'                                        // 外部账号列表
  ...
  // 活动
  export const eventAllInstitution = '/api/admin/activity/getAllInstitution'                                         // 活动类别
...
export const goodsCategoryList = '/api/admin/product/getAllProductCategory?a=b'                                        // 商品类别
  export const goodsDetail = '/api/admin/product/detailForAdmin'                                                     // 活动详情
